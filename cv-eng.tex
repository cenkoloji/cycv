...
succesfully finished all my projects/tasks and developed efficient solutions for problems I encountered.\\
- I highly value collaborative spirit.\\
- I am skilled in working in collaborative environment in an efficient manner.\\
- I can acquire new skills depending on the needs of the project.\\
...
Feb, 2014 - ... , &  \textsl{CERN - Beam Line for Schools}, Project Associate\\
            &\href{http://cern.ch/bl4s}{http://cern.ch/bl4s} \\
             ...
             &- Detector Responsible: Main responsible of the detectors that is used in the beam line, such as
             Delay Wire Chambers, Lead Glass Calorimeters, Scintillators, Cherenkov Counters. The responsibility
             consists of performance tests, calibration, commissioning, installation and analysis of detectors. \\
             ...
             &- Physics Analysis: Developed a C++ and ROOT based analysis software. The software is highly modifiable via configuration files for use in next years competition with different experimental setups.\\
             &- Optimization of the experiment: Performed the feasibility study on the physics of the winning experiment and suggested
             ...
             &- Installation and running of the experiment: The experimental setup is installed at East Area, T9 beamline and 2 different experiments was run for a week,
             during which beam parameters were modified according to needs of experiments.\\
             &- Documentation: Prepared detailed documentation and Twiki pages about every aspect of the project to ensure the knowledge
...
2009 - 2014 , & \textsl{CERN - CERN Axion Solar Telescope}, Doctoral Researcher\\
             ...
             &- CAST Contact person: Trained official CERN guides at CAST, maintained the visitor area, updated CAST
