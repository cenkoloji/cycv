...
physics analysis, data acquisition/readout systems, monitoring/control systems and vacuum systems. 
...
Dec, 2014 - ... , &  \textsl{University of California, Irvine}, Post Doctoral Scholar\\
             ...
             &\textbullet {\bf Operations}: Carried out the day-to-day operation responsibility of the CSC Run-II off detector readout system.\\
             &\textbullet {\bf Integration with ATLAS Trigger-DAQ (TDAQ)}: Took part in integration of the CSC off-detector readout system with the
             TDAQ infrastructure and implementation of recovery systems.\\
             &\textbullet {\bf Hardware}: Hardware installation and optical power measurements.\\
             ...
             trained other on-call responsibles on the CSC off-detector readout system.\\
             &\textbullet {\bf Monitoring}: Implementation of monitoring applications to monitor system status. \\
             &\textbullet {\bf Test Stand}: Built a test stand for the off detector readout system. \\
...
2009 - 2014 , & \textsl{CERN - CERN Axion Solar Telescope}, Doctoral Researcher\\
             ...
             &\textbullet {\bf Analysis:} Developed new methods for interpreting CAST data using results of the CFD simulations.\\
