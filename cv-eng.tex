...
%Contact Info {{{
\begin{comment} %{{{  REMOVED OLD PART
...
I am a Doctor of physics with several years experience in experimental particle physics, with focus on the following areas:
particle detectors(commissioning, installation, hardware maintenance, data acquisition, performance tests and analysis),
operations and data acquisition/readout systems.
...
Dec 2014 - now  &  \textsl{University of California, Irvine}, Post Doctoral Scholar/Project Scientist at the ATLAS Experiment \\
             & In my current post, I carry responsibilities in Muon Spectrometer and Trigger and Data Acquisition of the
             ATLAS Experiment.\\
             & \\
             & \bf { \underline {Muon Spectrometer - CSC Run-II Readout System:}} \\
             &\textbullet\ {\bf Commissioning and Integration}: Commissioning of the CSC Run-II off-detector readout system, integration with the
             TDAQ infrastructure, implementation of recovery and monitoring systems, performance tests.\\
             &\textbullet\ {\bf Operations}: Day-to-day operation of the CSC Run-II off detector readout system.\\
             &\textbullet\ {\bf Hardware}: Setting up a test stand of the readout system, hardware installation and optical power measurements.\\
             &\textbullet\ {\bf On-call responsibilities}: CSC DAQ on-call, MDT/CSC primary on-call duties.\\
             %&\textbullet\ {\bf Documentation/Training}: Preparing extensive documentation on various parts of the readout system,\\
             &\textbullet\ {\bf Coordination}: Carrying out Muon DAQ Coordination task since 2016, coordinating muon sub-systems on DAQ related issues \\
             & \\
             & \bf { \underline {Muon Spectrometer - Upgrade:}} \\
             &\textbullet\ {\bf Commissioning and Integration}: Integration testing of New Small Wheel(NSW) front end board. \\
             &\textbullet\ {\bf Software}: Development of configuration framework for NSW project \\
             & \\
             & \bf { \underline {Trigger and Data Acquisition System:}} \\
             &\textbullet\ {\bf Operations}: DAQ/HLT on-call duties. \\
             &\textbullet\ {\bf ATLAS Event Monitoring}: Working on event monitoring, improving its efficiency in terms of network utilization. \\
             &\textbullet\ {\bf High Level Trigger}: Design and development of HLT Processing Unit software for ATLAS
             Phase-I, development of monitoring tools to archive HLT rates. \\
             & \\
             & \bf {\underline {Other:}} \\
             &\textbullet\ {\bf Run Manager}: ATLAS Run Manager duty for few weeks in 2016, organizing the general scheduling of ATLAS \\
             \\

\newpage

Feb - Dec 2014 &  \textsl{CERN - Beam Line for Schools}, Project Associate (\href{http://cern.ch/bl4s}{http://cern.ch/bl4s})\\
             & I worked as a Project Scientist in the first year of Beam Line For Schools as part of a small team.\\
             & \\
             &\textbullet\ {\bf Detector Responsible}: Responsible of the detectors that is used in the beam line, such as
             Delay Wire Chambers, Lead Glass Calorimeters, Scintillators, Cherenkov Counters. The responsibility
             consisted of testing, calibration, commissioning, installation and analysis of detectors. \\
             &\textbullet\ {\bf DAQ:} Implementing an acquisition and monitoring software using NIM and VME systems on hardware,
             and ATLAS TDAQ Framework on the software side.\\
             &\textbullet\ {\bf Analysis:} Developing a C++ and ROOT based analysis software.\\
             &\textbullet\ {\bf Organization:} Organizing meetings with experts/technicians, handling gas installation for detectors,
             radioactive source loans and mechanical/electrical work.\\
             &\textbullet\ {\bf Installation and running of the experiment}\\\\

2009 - 2014  & \textsl{Bogazici University/CERN - CERN Axion Solar Telescope}, Doctoral Researcher\\
             & As part of my doctoral studies, I worked in the CAST experiment, spending most of my time in CERN.\\\\
             &\textbullet\ {\bf Micromegas detectors:} Responsible of 2 micromegas detectors for installation and maintenance, data analysis, data
             acquisition system, upgrades and vacuum system. I did the analysis of the detectors for the data taken
             in 2008. The results are used in my PhD thesis and all relevant CAST papers. \\
             &\textbullet\ {\bf Analysis:} Developing new analysis methods for interpreting CAST data.\\
             &\textbullet\ {\bf Shift/Run Coordination:} Shift coordination during 2012, and run coordination during several periods of
             data taking. \\
             &\textbullet\ {\bf CAST Slow Control System:} Main responsible of the Labview based acquisition system for hardware
             maintenance, installation of new sensors and software upgrades.\\
             &\textbullet\ {\bf Magnet movement system:} Organizing and analysing Grid/Survey measurements which assure the CAST magnets
             solar tracking accuracy, developing new analysis methods.\\
             &\textbullet\ {\bf CAST Contact person:} Training official CERN guides at CAST, maintaining the visitor
             area, updating CAST posters, maintaining the CAST official website. \\\\
