...
Dec 2014 - now  &  \textsl{University of California, Irvine}, Post Doctoral Scholar at the ATLAS Experiment \\
             ...
             &\textbullet\ {\bf Commisioning and Integration}: Commisioning of the CSC off-detector readout system, integration with the
             ...
             &\textbullet\ {\bf Documentation/Training}: Prepared extensive documentation on various parts of the readout system,\\
             ...
             &\textbullet\ {\bf HLT Monitoring}: Developed tools to archive HLT rates and access them in Athena framework. \\
             &\textbullet\ {\bf ATLAS Event Monitoring}: Improved event monitoring in terms of efficiency and network optimization. \\
             & \\
             & \bf {\underline {Other:}} \\
             &\textbullet\ {\bf Other}: ATLAS Run Manager shifts in 2016, organizing the general scheduling of ATLAS \\
             \\
...
Feb - Dec 2014 &  \textsl{CERN - Beam Line for Schools}, Project Associate (\href{http://cern.ch/bl4s}{http://cern.ch/bl4s})\\
             ...
             &\textbullet\ {\bf Organization:} Took care of organizing meetings with experts/technicians, handled gas installation for detectors,
             ...
             beamline and 2 different experiments was run for a week\\
